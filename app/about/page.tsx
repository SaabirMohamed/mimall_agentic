...
const AboutPage = () => {
  return (
    <div className="container mx-auto my-8 pt-16">
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-gray-200 rounded-lg shadow-2xl overflow-hidden">
          ...
          <div className="space-y-6 text-lg">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 my-12">
              <div className="w-full md:w-1/2">
                <h2 className="text-3xl font-bold mb-4 text-gray-200">A Vision of Possibilities</h2>
                <p className="leading-relaxed">
            ...
            <h2 className="text-3xl font-bold mt-8 mb-4 text-gray-200">A Commitment to Excellence</h2>
            <p className="leading-relaxed">
            ...
            <h2 className="text-3xl font-bold mt-8 mb-4 text-gray-200">The Journey Continues</h2>
            <p className="leading-relaxed">
