...
const ProfessionalSignUp = () => {
  return (
    <div className="container mx-auto my-8 max-w-md">
      <h1 className="text-3xl font-bold mb-6 text-center">Sign Up as a Professional Service Provider</h1>
      <form className="bg-black bg-opacity-70 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mb-4">
          ...
          <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="profession" type="text" placeholder="e.g., Doctor, Dentist, Optician" />
        </div>
        <div className="mb-4">
